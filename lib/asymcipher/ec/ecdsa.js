...
function invoker(secureRandom, ECCurveFp, BigInteger){
...
if('undefined' != typeof module && 'undefined' != typeof module.exports){
    ...
    module.exports = function(p){
        return new invoker(secureRandom, ECCurveFp, BigInteger)(p);
    };
} else
    define(
        ['secureRandom', 'ecurve', 'bigi'], 
        function(secureRandom, ECCurveFp, BigInteger){
            return function(p){
                return new invoker(secureRandom, ECCurveFp, BigInteger)(p);
            };
        }
