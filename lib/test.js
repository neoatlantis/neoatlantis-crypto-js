...
test('Asymmetric Cipher: Encrypting and Decrypting of 1kB', function(){
    var ciphertext = asym2.encrypt(plaintext1K);
    var decrypted = asym1.decrypt(ciphertext);
    return crypto.util.buffer.equal(decrypted, plaintext1K);
});
...
if('undefined' != typeof document) document.close();
};
/****************************************************************************/
