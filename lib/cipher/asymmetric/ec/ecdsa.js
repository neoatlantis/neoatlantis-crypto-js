...
if('undefined' != typeof module && 'undefined' != typeof module.exports){
    ...
    var ret = invoker(ECCurveFp, BigInteger);

    module.exports = function(p){ return new ret(p); };
} else
    define(
        ['cipher/asymmetric/ec/ecurve', 'cipher/asymmetric/ec/bigi'], 
        function(ECCurveFp, BigInteger){
            var ret = invoker(ECCurveFp, BigInteger);
            return function(p){ return new ret(p); };
        }
    );
