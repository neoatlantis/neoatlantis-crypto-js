...
function AsymmetricCipher(algorithmName){
    ...
    // TODO encrypting schema duplicated: this common class and detailed EC instance.
    function encrypt(plaintextBuf){
        ...
        var lenBuf = new Uint32Array([encryptedTempKey.byteLength]).buffer;
    ...
    function decrypt(ciphertextBuf){
        ...
        return new root.cipher.symmetric().key(tempKey).decrypt(ciphertext);
    };
